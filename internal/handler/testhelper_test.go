...
func newTestServer(t *testing.T) *testServer {
	...
	r.Route("/v1", func(v1Router chi.Router) {
		...
		v1Router.Post("/roles", roleHandler.Create)
		v1Router.Get("/roles/{id}", roleHandler.GetByID)
		v1Router.Put("/roles/{id}", roleHandler.Update)
		v1Router.Delete("/roles/{id}", roleHandler.Delete)
		v1Router.Get("/roles/{roleID}/permissions", permissionHandler.ListByRole)

		v1Router.Post("/permissions", permissionHandler.Create)
		v1Router.Get("/permissions/{id}", permissionHandler.GetByID)
		v1Router.Put("/permissions/{id}", permissionHandler.Update)
		v1Router.Delete("/permissions/{id}", permissionHandler.Delete)

		v1Router.Get("/users", userHandler.List)
		v1Router.Post("/users", userHandler.Create)
		v1Router.Get("/users/{id}", userHandler.GetByID)
		v1Router.Put("/users/{id}", userHandler.Update)
		v1Router.Put("/users/{id}/password", userHandler.UpdatePassword)
		v1Router.Delete("/users/{id}", userHandler.Delete)

		v1Router.Get("/composites", compositeHandler.List)
		v1Router.Post("/composites", compositeHandler.Create)
		v1Router.Get("/composites/slug/{slug}", compositeHandler.GetBySlug)
		v1Router.Get("/composites/{id}", compositeHandler.GetByID)
		v1Router.Put("/composites/{id}", compositeHandler.Update)
		v1Router.Delete("/composites/{id}", compositeHandler.Delete)

		v1Router.Get("/composites/{compositeID}/fields", fieldHandler.ListByComposite)
		v1Router.Post("/fields", fieldHandler.Create)
		v1Router.Get("/fields/{id}", fieldHandler.GetByID)
		v1Router.Put("/fields/{id}", fieldHandler.Update)
		v1Router.Delete("/fields/{id}", fieldHandler.Delete)
		...
		v1Router.Put("/entities/{id}", entityHandler.Update)
		v1Router.Delete("/entities/{id}", entityHandler.Delete)
		...
		v1Router.Delete("/field-values/{id}", fieldValueHandler.Delete)
	})
