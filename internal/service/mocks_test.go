...
type mockEntityRepo struct {
	getByID func(ctx context.Context, id uuid.UUID) (*models.Entity, error)
}

func (m *mockEntityRepo) Create(ctx context.Context, entity *models.Entity, parentID *uuid.UUID, afterID *uuid.UUID) (*models.Entity, error) {
	return nil, nil
}
func (m *mockEntityRepo) GetByID(ctx context.Context, id uuid.UUID) (*models.Entity, error) {
	if m.getByID != nil {
		return m.getByID(ctx, id)
	}
	return nil, pgx.ErrNoRows
}
func (m *mockEntityRepo) GetBySlug(ctx context.Context, compositeID uuid.UUID, slug string) (*models.Entity, error) {
	return nil, pgx.ErrNoRows
}
func (m *mockEntityRepo) ListByComposite(ctx context.Context, compositeID uuid.UUID, p repository.Pagination) (*repository.Page[models.Entity], error) {
	return nil, nil
}
func (m *mockEntityRepo) ListChildren(ctx context.Context, parentID uuid.UUID, p repository.Pagination) (*repository.Page[models.Entity], error) {
	return nil, nil
}
func (m *mockEntityRepo) Move(ctx context.Context, id uuid.UUID, parentID *uuid.UUID, afterID *uuid.UUID) error {
	return nil
}
func (m *mockEntityRepo) MoveRoot(ctx context.Context, id uuid.UUID, afterID *uuid.UUID) error {
	return nil
}
func (m *mockEntityRepo) Update(ctx context.Context, entity *models.Entity) (*models.Entity, error) {
	return nil, nil
}
func (m *mockEntityRepo) Delete(ctx context.Context, id uuid.UUID, deletedBy uuid.UUID) error {
	return nil
}
